    ...
    switch ($_POST['action']) {
        ...
        case 'save_preferences':
            $ok = saveNotificationPreferences($conn, $user_id, [
                ...
                'group_notifications_enabled' => '0', // not applicable for grocery admin
                'email_enabled'               => '0', // not applicable for grocery admin
            ]);
                    ...
                    <form id="prefsForm">
                        <div class="settings-group">
                            ...
                            <div class="toggle-row">
                                <div><div class="toggle-label">Low Stock Alerts</div><div class="toggle-desc">Items at or below reorder level</div></div>
                            ...
                            <div class="toggle-row">
                                <div><div class="toggle-label">Store Expiry Alerts</div><div class="toggle-desc">Store inventory expiring soon</div></div>
                            ...
                            <div class="toggle-row">
                                <div><div class="toggle-label">Purchase Order Updates</div><div class="toggle-desc">PO status changes &amp; deliveries</div></div>
                            ...
                            <div class="toggle-row">
                                <div><div class="toggle-label">Supplier Alerts</div><div class="toggle-desc">Supplier &amp; pricing updates</div></div>
...
document.getElementById('prefsForm').addEventListener('submit', async (e) => {
    ...
    const checkboxes = ['expiry_enabled','low_stock_enabled','achievement_enabled','system_enabled'];
