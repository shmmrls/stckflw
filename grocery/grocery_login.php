            ...
            <form method="POST" action="" class="luxury-auth-form" novalidate>
                ...
                <div class="auth-footer">
                    <p style="font-size: 12px; color: #666; margin-top: 20px;">
                        Customer? <a href="<?php echo htmlspecialchars($baseUrl); ?>/user/login.php" style="color: #000; font-weight: 500;">Sign in here</a>
                    </p>
                </div>
            </form>
        </div>
            ...
            <form method="POST" action="" class="luxury-auth-form" novalidate>
                ...
                <div class="auth-footer">
                    ...
                    <p style="font-size: 12px; color: #666; margin-top: 15px;">
                        Customer? <a href="<?php echo htmlspecialchars($baseUrl); ?>/user/login.php#register" style="color: #000; font-weight: 500;">Register here</a>
                    </p>
                </div>
            </form>
        </div>
